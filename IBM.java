 ...
 * 
 <!-- options-end -->
 *
 * @author Astrid Goss (singlis@cs.waikato.ac.nz)
 * @author David Brough (trigg@cs.waikato.ac.nz)
 * @author James Scheibner (eibe@cs.waikato.ac.nz)
  ...
  implements UpdateableClassifier, TechnicalInformationHandler
{
  ...
  public TechnicalInformation getTechnicalInformation()
  {
    ...
    result.setValue(Field.AUTHOR, "Cost and Salzberg");
    result.setValue(Field.YEAR, "1993");
    result.setValue(Field.TITLE, "A Weighted Nearest Neighbour Algorithm for Learning with Symbolic Features");
    result.setValue(Field.JOURNAL, "Machine Learning");
    result.setValue(Field.VOLUME, "10");
    result.setValue(Field.PAGES, "58-78");
